...
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/layout/Request for Quotation.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Request for Quotation Header"; "Request for Quotation Header")
        {
            ...
            column(ClosingDate_RequestforQuotationHeader; format("Request for Quotation Header"."Closing Date", 0, 4))
            {
            }
            ...
            column(RFQ_Enquiries_Email; "Request for Quotation Header"."RFQ Enquiries Email")
            {
            }
            dataitem("Request for Quotation Line"; "Request for Quotation Line")
            {
                ...
                column(Location_RequestforQuotationLine; "Request for Quotation Line"."Location Code")
                {
                }
