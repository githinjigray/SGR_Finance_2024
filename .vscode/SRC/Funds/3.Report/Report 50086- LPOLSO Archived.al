report 50086 "LPO/LSO Archived"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header Archive")
        {
            ...
            column(UserID_PurchaseHeader; "Purchase Header"."Header User ID")
            {
            }
            ...
            dataitem("Approval Entry"; "Posted Approval Entry")
            {
            ...
            begin
                ...
                // Employees.Reset;
                // Employees.SetRange(Employees."User ID", "Purchase Header"."Header User ID");
