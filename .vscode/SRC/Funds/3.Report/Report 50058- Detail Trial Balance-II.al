        ...
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem("G/L Entry"; "G/L Entry")
                {
                    ...
                    column(ShortcutDimension3Code_GLEntry; "G/L Entry"."Shortcut Dimension 3 Code")
                    {
                    }
                    column(ShortcutDimension4Code_GLEntry; "G/L Entry"."Shortcut Dimension 4 Code")
                    {
                    }
                    column(ShortcutDimension5Code_GLEntry; "G/L Entry"."Shortcut Dimension 5 Code")
                    {
                    }
                    column(ShortcutDimension6Code_GLEntry; "G/L Entry"."Shortcut Dimension 6 Code")
                    {
                    }
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(UserFilter; UserFilter)
                    {
                        ...
                        Caption = 'User Filter';
                        ToolTip = 'Specifies if you want the report to show only the entries for a certain user';
                    }
                }
            }
        }
