codeunit 50029 "Bank Acc.Recon Post2"
{
    ...
    var
        ...
        NewText0001: Label 'The reconciliation is incomplete! The net change between statement ending balance and balance last statement does not equal the reconciled amounts';
    ...
    begin
        with BankAccRecon do begin
            ...
            BankAccReconLine.SetRange(Reconciled, false);//****This is an addition
            if BankAccReconLine.Find('-') then
                repeat

                    //BankAccReconLine.RemoveApplication(BankAccReconLine.Type); //note that the function "Removeapplication" property on the table has been modified Bank Recon Line to No from yes
            ...
            BankAccReconLine.SetRange(Reconciled, true);//****This is an addition

            //End for upgrade addition
            TotalAmount := 0;
    ...
    begin
        with BankAccReconLine do begin
            ...
            CalcSums("Statement Amount", Difference, "Applied Amount");
