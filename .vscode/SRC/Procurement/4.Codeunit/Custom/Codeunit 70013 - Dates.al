codeunit 70013 Dates
{
    ...
    procedure ConvertDate2(nDate: Date) strDate: Text[30]
    var
        lDay: Integer;
        lMonth: Integer;
        lYear: Integer;
    ...
    begin
        ...
        IF lMonth=1 THEN BEGIN StrMonth:=' Jan ' END;
        IF lMonth=2 THEN BEGIN StrMonth:=' Feb ' END;
        IF lMonth=3 THEN BEGIN StrMonth:=' Mar ' END;
        IF lMonth=4 THEN BEGIN StrMonth:=' Apr ' END;
        IF lMonth=5 THEN BEGIN StrMonth:=' May ' END;
        IF lMonth=6 THEN BEGIN StrMonth:=' June ' END;
        IF lMonth=7 THEN BEGIN StrMonth:=' July ' END;
        IF lMonth=8 THEN BEGIN StrMonth:=' Aug ' END;
        IF lMonth=9 THEN BEGIN StrMonth:=' Sept ' END;
        IF lMonth=10 THEN BEGIN StrMonth:=' Oct ' END;
        IF lMonth=11 THEN BEGIN StrMonth:=' Nov ' END;
        IF lMonth=12 THEN BEGIN StrMonth:=' Dec ' END;
