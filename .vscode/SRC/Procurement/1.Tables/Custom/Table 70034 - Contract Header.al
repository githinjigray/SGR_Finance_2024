table 70034 "Contract Header2"
{
    ...
    fields
    {
        ...
        field(4; "Account No."; Code[20])
        {
            ...
            DataClassification = ToBeClassified;
            NotBlank = true;
            TableRelation = IF ("Account Type" = CONST(Employee)) Employee ELSE
        ...
        field(18; "Contract Status"; Option)
        {
            ...
            DataClassification = ToBeClassified;
            Editable = false;
            OptionCaption = 'Draft,Under Legal,Active,Pending,Terminated,Archived,Expired';
            OptionMembers = Draft,"Under Legal",Active,Pending,Terminated,Archived,Expired;
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Contract,MOU,Addendum,SLA,Contract-SLA';
            OptionMembers = " ",Contract,MOU,Addendum,SLA,"Contract-SLA";
        }
        ...
        {
            CalcFormula = Lookup("Dimension Value".Name WHERE(Code = FIELD("Global Dimension 2 Code"), "Global Dimension No." = CONST(2)));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(300; "Currency Code"; Code[20])
        {
    ...
    begin
        ...
        IF "No." = '' THEN BEGIN
            GeneralSetup.GET;
            GeneralSetup.TESTFIELD("Contract Nos");
            NoSeriesManagement.GetNextNo(GeneralSetup."Contract Nos", Today, false);
        END;
